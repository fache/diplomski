...
export default {
    ...
    beforeMount (){
        ...
        axios.get('http://localhost/api_v5/group/course/'+this.predmet+'/allStudents', { withCredentials: true }).then((res) => {
            for(let i=0; i<res.data.members.length; i++){
                var obj=res;
                axios.get('http://localhost/api_v5/person/'+obj.data.members[i].Person.id, { withCredentials: true }).then((res) => {
                    var student={};
