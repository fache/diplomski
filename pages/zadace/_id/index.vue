        ...
        <div class="ui segment">
            <div class="ui form" style="max-width: 400px; margin: auto;">
                <div class="field">
                    ...
                    <div class="ui input">
                        <input type="text" id="nazivZadace" name="nazivZadace" placeholder="">
                    </div>
                </div>
                <div class="two fields">
                    <div class="field">
                        ...
                        <div class="ui input">
                            <input type="text" id="brojZadatka" name="brojZadatka" placeholder="">
                        </div>
                    </div>
                    <div class="field">
                        <label>Max. broj bodova:</label>
                        <div class="ui input">
                            <input type="text" id="maxBodovi" name="maxBodovi" placeholder="">
                        </div>
                    </div>
                </div>
                <div class="field">
                ...
                <div class="field">
                    ...
                    <select id="programskiJezik" class="ui fluid search dropdown">
...
export default {
    ...
    methods:{
        ponistiFormu: function(){
            ...
            $("#brojZadatka").val("");
            $("#maxBodovi").val("");
            $("#aktivna").prop("checked",false)
            $("#readonly").prop("checked",false)
            $("#attachment").prop("checked",false)
            $('#programskiJezik').prop('selectedIndex', 0);
        } 
    },
    components: {
    ...
    beforeMount (){
        ...
        axios.get('http://localhost/api_v5/homework/course/'+ this.predmet, { withCredentials: true }).then((res) => {
